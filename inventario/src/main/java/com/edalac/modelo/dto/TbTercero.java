...
public class TbTercero implements java.io.Serializable {
	...
	public TbTercero(long nbIdpersona, TbCiudad tbCiudad, TbTipopersona tbTipopersona, TbTipodocumento tbTipodocumento,
			TbEstado tbEstado, String vrApellidos, String vrNombres, String vrRazonSocial, String vrDireccion,
			String vrEmail, Long nbNit, Integer nbDigitoverificacion, String vrTelefono, Set tbFacturas) {
		this.nbIdpersona = nbIdpersona;
		this.tbCiudad = tbCiudad;
		this.tbTipopersona = tbTipopersona;
		this.tbTipodocumento = tbTipodocumento;
